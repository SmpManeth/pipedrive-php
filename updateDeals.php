        ...
        <div class="container">
            <form class="form-horizontal" role="form" action="updateDeals.php" method="GET">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input name="organization" id="organization" type="text" placeholder="Organization"
                            class="form-control" value="<?php echo $value['organization'] ?>" autofocus>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="Contact_person_Name" id="Contact_person_Name"
                            ...
                            value="<?php echo $value['Contact_person_Name']; ?>" autofocus>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="Email_Address" id="Email_Address" placeholder="Email"
                            class="form-control" name="email" value="<?php echo $value['Email_Address']; ?>">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="Phone_No" id="Phone_No" placeholder="Phone_No" class="form-control"
                            value="<?php echo $value['Phone_No']; ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label for="birthDate" class="col-sm-3 control-label">Prospected Closing Date</label>
                    <div class="col-sm-9">
                        <input type="date" name="prospected_closing_date" class="form-control"
                            value="<?php echo $value['prospected_closing_date']; ?>">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="date" name="expected_closing_date" class="form-control"
                            value="<?php echo $value['expected_closing_date']; ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label for="comment" class="col-sm-3 control-label">Stages</label>
                    <div class="col-sm-9">
                        <input type="text" name="status_id" class="form-control"
                            value="<?php echo $value['status_id']; ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label for="comment" class="col-sm-3 control-label">Comments</label>
                    <div class="col-sm-9">
                        <input type="text" name="deal_comment" class="form-control"
                            value="<?php echo $value['deal_comment']; ?>">
                    </div>
                </div>
                <div class="form-group">
