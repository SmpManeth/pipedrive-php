...
<div class=" d-flex side-bar fixed-top ">
    ...
    <div class="nav flex-column nav-pills1" id="v-pills-tab" role="tablist" aria-orientation="vertical">
        <a class="button nav-link lead_buttons " href="<?php echo $BASE_URL . 'leads.php' ?>">

            <h7>Leads</h7>
        </a>
        <br> <a class="button nav-link lead_buttons " href="<?php echo $BASE_URL . 'deals.php' ?>">
