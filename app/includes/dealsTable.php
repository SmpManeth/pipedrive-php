...
<div class="tab-pane fade show table-cont">
  ...
  <div class="mb-3">
    <form class="form-horizontal well" action="dashboard.php" method="post" name="upload_excel" enctype="multipart/form-data">
      ...
      if (mysqli_num_rows($results) > 0) { ?> 
          <?php foreach ($results as $key => $onerow) {?>
            ...
            <tr>
              ...
              <td><div class="shadow btnfilter">
                        <a href="<?php echo $BASE_URL . 'app/includes/updateDeals.php'?>?dealid=<?php echo $onerow['id']?>?deal_org=<?php echo $onerow['organization']?>?deal_conta=<?php echo $onerow["Contact_person_Name"]; ?>?deal_email=<?php echo $onerow["Email_Address"]; ?>?deal_addre=<?php echo $onerow["Address"]; ?>?deal_phone=<?php echo $onerow["Phone_No"]; ?>?deal_pos=<?php echo $onerow["prospected_closing_date"]; ?>?deal_expe=<?php echo $onerow["expected_closing_date"]; ?>">
