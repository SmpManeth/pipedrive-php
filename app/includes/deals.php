                                        ...
                                        <li class="text-row ui-sortable-handle" data-task-id="<?php echo $deal["id"]; ?>">
                                            ...
                                            <div class="nav nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                                <form action="dealsDetails.php" method="post">
                                                    ...
                                                    <button name="clickme-deal-btnn" class="nav-link lead_buttons clickmebtn" data-bs-toggle="pill" data-bs-target="#v-pills-dealsDetails" type="button" role="tab" aria-controls="v-pills-home" aria-selected="true" id="mybtn" value="<?php echo $deal["title"]; ?>">
